...
class MSDeformAttnFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        # NOTE: We Added this because Half precision does not work here...
        ...
        # NOTE: We Added this because Half precision does not work here...
        grad_value = grad_value.half()
        grad_sampling_loc = grad_sampling_loc.half()
        grad_attn_weight = grad_attn_weight.half()
