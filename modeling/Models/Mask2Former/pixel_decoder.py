...
from modeling.Models.Mask2Former.utils.batch_norm import get_norm
from modeling.Models.Mask2Former.utils.position_encoding import PositionEmbeddingSine
from modeling.Models.Mask2Former.utils.transformer import _get_clones, _get_activation_fn
from modeling.Models.Mask2Former.utils.ms_deform_attn import MSDeformAttn
...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        use_bias = norm == ""
        for _, in_channels in enumerate(self.feature_channels[:1]):  # TODO self.num_fpn_levels]):
